...
<?php endif; ?>
        ...
        <article class="post-content">
          <div class="redblock"><i class="fas fa-exclamation-circle"></i>&nbsp;&nbsp;文章最后更新于：<time class="date"><?php $this->date("Y年m月d日 H:i"); ?></time>.<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;受某些因素影响，本文章可能具有一定的时效性，请以实际情况为准！另外，欢迎留言~</div>
